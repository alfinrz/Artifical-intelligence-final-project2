...
def rel_to_abs(rel_traj, start_pos): # this function converts relative trajectory to absolute trajectory
...
def constant_velocity_model(observed, sample=False): # this function is the constant velocity model
    """
...
def evaluate_testset(testset): # this function evaluates the testset
...
class ConstantVelocityModel(nn.Module): # this is the constant velocity model
    def __init__(self):
